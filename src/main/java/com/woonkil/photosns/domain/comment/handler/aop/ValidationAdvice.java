package com.woonkil.photosns.domain.comment.handler.aop;

import com.woonkil.photosns.domain.comment.handler.ex.CustomValidationException;
import com.woonkil.photosns.domain.comment.handler.ex.CustomValidationApiException;
...
@Slf4j
@Component("photosns.ValidationAdvice") // Restcontoller, Service 가  Component 의 구현체다.
@Aspect
public class ValidationAdvice {

    @Around("execution(* com.woonkil.photosns.web.api.*Controller.*(..))") // Before, After
    ...
    @Around("execution(* com.woonkil.photosns.web.*Controller.*(..))") // Before, After
