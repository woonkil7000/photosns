...
<head>
    ...
    <link type="text/css" href="/auth/signin.css">
...
<body class="text-center pt-sm-0 pt-md-3">
            <form action="/login" method="post">
                ...
                <h1 class="h3 mb-3 font-weight-normal">Please sign in</h1>
                           ...
                           <c:choose>
                               <c:when test="${param.error}">
                                   <div class="btn btn-warning">${test1}ID 또는 패스워드가 일치하지 않습니다</div>
                               </c:when>
                           </c:choose>
                           <c:choose>
                               <c:when test="${param.logout}">
                                   <div class="btn btn-warning">${test2}로그 아웃되었습니다</div>
                               </c:when>
                           </c:choose>
                <div>
                ...
                <div>
                <label class="alert alert-light col-md-2 mt-1 mb-0" role="alert">테스트용 ID="test" 비번="111"</label>
                </div>
                <div>
...
<%--                        </div>--%>
                    ...
                    <div>
                           ...
                           <button class="btn btn-outline-dark mt-3" onclick="javascript:location.href='/oauth2/authorization/kakao'">
                    ...
                    <div>
                           <!-- <button onclick="javascript:location.href='/oauth2/authorization/google'"> -->
                           <button class="btn btn-outline-dark mt-2"  onclick="javascript:location.href='/oauth2/authorization/naver'">
                               <!-- <i class="fab fa-google-plus-square"></i> -->
                       ...
                       <div>
                           <!-- <button onclick="javascript:location.href='/oauth2/authorization/google'"> -->
                           <button class="btn btn-outline-dark mt-2"  onclick="javascript:location.href='/oauth2/authorization/google'">
                               <!-- <i class="fab fa-google-plus-square"></i> -->
                        ...
                        <div>
                            ...
                            <button class="btn btn-outline-dark mt-2"  onclick="javascript:location.href='/oauth2/authorization/facebook'">
